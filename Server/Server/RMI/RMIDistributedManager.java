...
public class RMIDistributedManager extends DistributedResourceManager {
    ...
    public static void main(String args[])
    {
        ...
        try {
            ...
            Registry l_registry;
            try {
                l_registry = LocateRegistry.createRegistry(1045);
            } catch (RemoteException e) {
                l_registry = LocateRegistry.getRegistry(1045);
            }
    ...
    public RMIDistributedManager(String name)
    {
        super(name);
    }
}
